...
data class LibraryEntryUi(
    ...
    val isObtainable: Boolean? = null,
    val acquisitionSources: List<String> = emptyList(),
    val combatRoles: List<String> = emptyList(),
    val associatedResonator: String? = null,
    val passiveName: String? = null,
    val passiveDescription: String? = null,
    val maxLevel: Int? = null,
    val level1Stats: Map<String, String> = emptyMap(),
    val maxLevelStats: Map<String, String> = emptyMap(),
    ...
    fun matches(context: Context, query: String): Boolean {
        ...
        return sequenceOf(
            ...
            *metadata.flatMap { listOf(it.first, it.second) }.toTypedArray(),
            availability,
            *acquisitionSources.toTypedArray(),
            *combatRoles.toTypedArray(),
